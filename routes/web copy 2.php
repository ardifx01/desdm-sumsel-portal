...
use App\Http\Controllers\Admin\DokumenCategoryController;
use App\Http\Controllers\Admin\DocController;
use App\Http\Controllers\Admin\InformasiPublikCategoryController;
use App\Http\Controllers\Admin\AlbumController;
use App\Http\Controllers\Admin\PhotoController; // <-- TAMBAHKAN BARIS INI
...
// --- Rute MODUL PUBLIK (Yang Sudah Kita Buat Sebelumnya) ---
...
// Penting: Pastikan ini di atas group 'informasi-publik' jika ada wildcard {slug} di group informasi-publik
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::resource('categories', CategoryController::class); // <-- PASTIKAN INI CategoryController::class
        // CRUD Berita
        Route::resource('posts', PostController::class);

        // CRUD Kategori Dokumen
        Route::resource('dokumen-categories', DokumenCategoryController::class)->parameters([
            'dokumen-categories' => 'category_dokumen', // <-- TAMBAHKAN INI
        ]);

        // CRUD Dokumen
        Route::resource('dokumen', DocController::class)->parameters([
            'dokumen' => 'dokuman', // <-- TAMBAHKAN BARIS INI (ubah parameter menjadi {dokuman})
        ]);
