                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.videos.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="url" name="thumbnail" id="thumbnail" value="{{ old('thumbnail') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Contoh: https://img.youtube.com/vi/XXXXX/hqdefault.jpg">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Simpan Video</button>
                        </div>
                    </form>
                </div>
            </div>
