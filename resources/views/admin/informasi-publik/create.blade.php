<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Item Informasi Publik Baru') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.informasi-publik.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="konten" id="konten" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 tinymce-editor">{{ old('konten') }}</textarea> {{-- TinyMCE will initialize here --}}
                        </div>

                        <div class="mb-4">
                            <label for="file_dokumen" class="block text-sm font-medium text-gray-700">Upload File Dokumen Terkait <small>(Opsional, PDF, DOCX, XLSX, PPTX, Max 5MB)</small></label>
                        ...
                        <div class="mb-4">
                            <label for="thumbnail" class="block text-sm font-medium text-gray-700">Upload Thumbnail (Gambar) <small>(Opsional, JPG, PNG, GIF, SVG, Max 2MB)</small></label>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Simpan Item</button>
                        </div>
                    </form>
                </div>
            </div>
