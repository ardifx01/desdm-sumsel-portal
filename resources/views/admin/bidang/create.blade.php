<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Bidang, UPTD, atau Cabang Dinas Baru') }}
        </h2>
    </x-slot>
                    ...
                    <form action="{{ route('admin.bidang.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="tipe" id="tipe" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                ...
                                <option value="bidang" {{ old('tipe') == 'bidang' ? 'selected' : '' }}>Bidang</option>
                                <option value="UPTD" {{ old('tipe') == 'UPTD' ? 'selected' : '' }}>UPTD</option>
                                <option value="cabang_dinas" {{ old('tipe') == 'cabang_dinas' ? 'selected' : '' }}>Cabang Dinas</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="tupoksi" id="tupoksi" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 tinymce-editor">{{ old('tupoksi') }}</textarea> {{-- TinyMCE will initialize here --}}
                        ...
                        <div class="mb-4" id="wilayah_kerja_field">
                            ...
                            <x-text-input id="wilayah_kerja" class="block mt-1 w-full" type="text" name="wilayah_kerja" :value="old('wilayah_kerja')" />
                        ...
                        <div class="mb-4" id="alamat_field">
                            ...
                            <textarea name="alamat" id="alamat" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('alamat') }}</textarea>
                        ...
                        <div class="mb-4" id="map_field">
                            ...
                            <textarea name="map" id="map" rows="5" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('map') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="grafik_kinerja" id="grafik_kinerja" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 tinymce-editor">{{ old('grafik_kinerja') }}</textarea> {{-- TinyMCE will initialize here --}}
...
</x-app-layout> {{-- Tag penutup x-app-layout HARUS ADA DI AKHIR FILE --}}