                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.static-pages.update', $staticPage) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $staticPage->title) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
                        </div>
                        <div class="mb-4">
                            <label for="content" class="block text-sm font-medium text-gray-700">Konten Halaman</label>
                            <textarea name="content" id="content" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 tinymce-editor">{{ old('content', $staticPage->content) }}</textarea>
                        </div>
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Perbarui Halaman</button>
                        </div>
                    </form>
                </div>
            </div>
