            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('admin.posts.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Tambah Berita Baru</a>
                    </div>
                    ...
                    <div class="mb-4">
                        <form action="{{ route('admin.posts.index') }}" method="GET" class="flex space-x-2">
                            ...
                            @if(request('q') || request('category_id') || request('status'))
                                <a href="{{ route('admin.posts.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">Reset</a>
                            @endif
                        </form>
                    </div>
