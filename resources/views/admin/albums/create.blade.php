            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.albums.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label for="thumbnail" class="block text-sm font-medium text-gray-700">Thumbnail Album <small>(Opsional, hanya gambar: JPG, PNG, GIF, SVG, Max 2MB)</small></label>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Simpan Album</button>
                        </div>
                    </form>
                </div>
            </div>
